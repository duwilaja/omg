...
$sql="select clientid,clientname,rowid from t_clients";
			...
			<div class="card-body">
			  <div class="form-group row">
				...
				<div class="col-sm-8 input-group">
				  <input type="text" name="clientid" class="form-control form-control-sm" id="clientid" placeholder="...">
				</div>
			  </div>
			  <div class="form-group row">
				<label for="" class="col-sm-4 col-form-label">Name</label>
				<div class="col-sm-8 input-group">
				  <input type="text" name="clientname" class="form-control form-control-sm" id="clientname" placeholder="...">
				</div>
			  </div>
			</div>
			<!-- /.card-body -->
